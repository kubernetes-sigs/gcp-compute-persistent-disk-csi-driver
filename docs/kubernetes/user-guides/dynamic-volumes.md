...
> **Important:** This feature is currently **unavailable** in standard GKE clusters. It is available for **manual deployments** of the GCE PD CSI Driver. See details below on how to enable and use this feature. 
...
The label format is: `disk-type.gke.io/{DISK_TYPE}=true`
