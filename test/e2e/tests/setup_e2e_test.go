...
var (
	...
	minCpuPlatform            = flag.String("min-cpu-platform", "cascadelake", "Minimum CPU architecture")
	zones                     = flag.String("zones", "us-east4-a,us-east4-c", "Zones to run tests in. If there are multiple zones, separate each by comma")
	machineType               = flag.String("machine-type", "n2-standard-80", "Type of machine to provision instance on")
