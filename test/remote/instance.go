...
func machineTypeMismatch(curInst *compute.Instance, newInst *compute.Instance) bool {
	...
	if curInst.ConfidentialInstanceConfig.EnableConfidentialCompute != newInst.ConfidentialInstanceConfig.EnableConfidentialCompute {
...
func (i *InstanceInfo) CreateOrGetInstance() error {
	...
	// If instance exists but setting differ, delete instance
